  ...
  return (
    <div>
      <button
        disabled
        type="button"
        className="text-white bg-[var(--primarycolor)] hover:bg-[var(--primarytextcolor)] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center me-2 inline-flex items-center"
      >
        <svg
          aria-hidden="true"
          role="status"
