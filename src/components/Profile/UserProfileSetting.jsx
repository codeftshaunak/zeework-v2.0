        ...
        <div className="flex flex-col gap-[8px] py-[20px] px-[24px] ">
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <div className="w-[100%]  py-[2px] px-[12px] outline-none border-[1px] rounded-md">
              <input
                type="text"
                className="w-full focus:outline-none  text-[14px] text-[#9CA3AF] font-[400] border-[var(--bordersecondary)] "
                placeholder="Title"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <div className="w-[100%]  py-[2px] px-[12px] outline-none border-[1px] rounded-md">
              <textarea
                type="text"
                className="w-full focus:outline-none h-[76px]  text-[14px] text-[#9CA3AF] font-[400] border-[var(--bordersecondary)] "
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <div className="w-[100%] cursor-pointer flex items-center bg-[#F0FDF4] justify-center py-[32px] px-[20px] border-dashed border-[#22C55E] border-[1px] rounded-md">
              <p className="text-[#374151] text-[14px] font-[400]">
                Drag or , <span className="text-[#22C35E]">upload</span> project
                Images
              </p>
            </div>
          </div>
          <div className="flex items-center justify-end gap-2 p-[24px] w-full border-t-[1px] border-t-[#F3F4F6] ">
            <button className="text-[14px] text-[#374151] font-[500] border-[1px] border-[var(--bordersecondary)] py-[4px] px-[20px] rounded-md ">
              Cancel
            </button>
            <button className="text-[14px] bg-[#22C35E] text-[#fff] font-[500]  py-[4px] px-[20px] rounded-md ">
              Save
            </button>
          </div>
        </div>
